<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RoleManagement.ascx.cs" Inherits="AspNot_Project_Raihan.UsersContorl.RoleManagement" %>
<br /> <br />
    ...
    <div class="row">
        <div class="col-sm-12 table-responsive">
            ...
            <asp:GridView ID="grdUsers" runat="server" DataKeyNames="Id"
                ...
                ItemType="AspNot_Project_Raihan.Models.ApplicationUser" 
